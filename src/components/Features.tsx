      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="ZaryahX learns from your interactions, continuously improving its responses and actions to better serve your needs."
            index={0}
          />
          <FeatureCard
            ...
            description="Communicate using natural language and gestures. ZaryahX understands context and responds appropriately."
            index={1}
          />
          <FeatureCard
          ...
          <FeatureCard
            ...
            description="Advanced sensors and mapping technology allow ZaryahX to navigate complex environments with ease."
            index={3}
          />
          <FeatureCard
          ...
          <FeatureCard
            ...
            description="From simple reminders to complex multi-step tasks, ZaryahX can assist with a wide range of activities."
            index={5}
          />
        </div>
      </div>
