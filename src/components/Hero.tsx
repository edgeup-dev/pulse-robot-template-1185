      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
              <div className="flex gap-2 mb-3 sm:mb-6 opacity-0 animate-fade-in" style={{
            animationDelay: "0.1s"
          }}>
          ...
          <div className="w-full lg:w-1/2 relative mt-6 lg:mt-0">
            ...
            animationDelay: "0.9s"
              ...
              <div className="w-full h-[500px] max-w-lg mx-auto rounded-2xl overflow-hidden shadow-2xl">
                <Spline scene="https://prod.spline.design/cA7xEdNqzMknmEbe/scene.splinecode" onLoad={() => console.log('Spline scene loaded successfully')} onError={error => console.error('Spline scene failed to load:', error)} />
              </div>
            </div>
          </div>
        </div>
